...
export default function DeleteUserModal(props) {
	const realDelete = async (id) => {
		await axios.delete(`${process.env.NEXT_PUBLIC_API_URL}/api/users/account/delete`, {
			data: {
				id: id
			}
		});
									...
									<div className='mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left'>
										...
										<div className='mt-2'>
											<p className='text-sm text-gray-500'>
												Are you sure you want to remove this account? All of your data will be
