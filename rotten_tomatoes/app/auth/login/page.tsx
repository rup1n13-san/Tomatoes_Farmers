...
export default function Login() {
	...
	const { setUserId } = useFavoritesStore();
		...
		<div className='bg-[url("/images/login.webp")] h-screen'>
			<div className='min-h-screen  flex items-center justify-center p-4'>
				<div className='max-w-lg w-full bg-black/60 rounded-xl shadow-lg p-8'>
					<h2 className='text-2xl font-bold text mb-6 text-center text-red-600'>Sign In</h2>
					...
					<form className='space-y-4' onSubmit={handleSubmit}>
						...
						<div className='flex items-center justify-between'>
							<label className='flex items-center'>
								<input
									type='checkbox'
									className='rounded border-gray-500 text-red-600 focus:ring-red-500 bg-black'
								/>
